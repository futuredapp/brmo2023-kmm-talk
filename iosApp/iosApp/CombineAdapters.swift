...
func createPublisher<T>(_ flowAdapter: StateFlowAdapter<T>) -> AnyPublisher<T, KotlinError> {
...
func doPublish<T>(_ flowAdapter: StateFlowAdapter<T>, onEach: @escaping (T) -> Void) -> Cancellable {
